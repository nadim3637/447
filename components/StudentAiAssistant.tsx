...
export const StudentAiAssistant: React.FC<Props> = ({ user, settings, isOpen: controlledIsOpen, onClose }) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const prompt = settings?.aiInstruction || "You are a helpful AI Tutor. Answer the student's question clearly and concisely. If it's a concept, explain it simply.";
    ...
    if (!isOpen) {
        // If controlled, return null. If internal (legacy usage), return button.
        // But in this new design, we removed the floating button in favor of Dock.
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-white flex flex-col animate-in fade-in">
            ...
            {/* Chat Area */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50 h-full">
                {messages.length === 0 && (
